...
describe("Testing the packetize-string classes", function () {
    ...
    describe("Making sure that the Reader class works", function () {
        ...
        let receiver, messageSpy, chunkSpy, partialSpy;
        ...
        it ('should be able to use Reader to receive a packet and conver it to a message', function (done) {
        ...
        it ('should be space out emits if there is more than one message in a chunk', function (done) {
    ...
    describe("Making sure that the Senders and Receivers work together.", function () {
        ...
        let sender, receiver, messageSpy, chunkSpy, partialSpy;
        ...
        it ("should be able to packetize a message with a Sender and use a Receiver to extract the message", function (done) {
            ...
            let packet = sender.all();
            expect(sender.hasPacket()).toBeFalsy();

            let chunks = 0;
            let size = Math.floor(packetSize/2);
